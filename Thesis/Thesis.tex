...
violent extremism (\textbf{whitehouse2018dyaing?}), which predicts that individuals who lump their personal
...
implications.
\#\textbar{} do I keep the above sentence ``The present study\ldots{}'' in oultining implications here, or move it?
...
\#\textbar{} again, should I keep the above sentence: ``Considering the measure's\ldots{}'' as it provides reason for the work, but seemingly more for a proposal structure than an actual thesis
...
\#\textbar{} Update manifesto selection examples in brackets.
\#\textbar{} Did I appropriately select manifestos according to their place on the political spectrum as indicated above?
...
\#\textbar{} Do I still agree with replacement? If so, I need to update run\_scoring again.
...
\#\textbar{} I forgot to do this part in time for integrative data project; IGNORE AUTOMATED INTEGRATIVE COMPLEXITY PARTS!
...
\#\textbar{} Need to include other categories of markers of violence condoning norms, perhaps even splitting the markers into categories such that I can examine prevalence of individual markers, marker categories, and violence condoning norms all together.
\#\textbar{} Probably need to rewrite this section, at least by tense, but also distribute in different areas of the methods.
...
\#\textbar{} Can use this for guide when witing actual discussion, so hold of on deleting.
...
\#\textbar{} Can use this for guide when witing actual Limitations, so hold of on deleting.
