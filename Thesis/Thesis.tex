...
\midrule
Integrative Complexity (z) & 0.13 & {}[0.01, 1.27] & 0.079\\
\bottomrule
\addlinespace
\end{tabular}
...
Predictor & \multicolumn{1}{c}{OR} & \multicolumn{1}{c}{CI} & \multicolumn{1}{c}{p}\\
\midrule
Integrative Complexity (z) & 0.04 & {}[0, 1] & 0.050\\
Dyadic Harm (z) & 1.95 & {}[0.63, 6.02] & 0.246\\
Justification for Violence (z) & 4.05 & {}[0.83, 19.88] & 0.084\\
Martyrdom Narrative (z) & 14.63 & {}[0.9, 238.87] & 0.060\\
Hopelessness (z) & 0.57 & {}[0.08, 4.12] & 0.579\\
\bottomrule
\addlinespace
\end{tabular}
...
\caption{\label{tab:multinomial-sensitivity}Multinomial logistic regression (sensitivity analysis) predicting 3-category manifesto classification from integrative complexity and marker prevalence.}

\begin{tabular}{llll}
\toprule
Comparison & \multicolumn{1}{c}{Term} & \multicolumn{1}{c}{RRR} & \multicolumn{1}{c}{CI}\\
\midrule
...
\begin{tablenotes}[para]
\normalsize{\textit{Note.} Estimated via nnet::multinom; relative risk ratios (RRR) are exponentiated coefficients. Values are Wald-based with 95\% confidence intervals.}
\end{tablenotes}
...
\midrule
Justification \textasciitilde{} IC + Time & ic & -0.15 & 0.13 & -1.11\\
Justification \textasciitilde{} IC + Time & time\_c & 0.00 & 0.00 & 0.35\\
IC \textasciitilde{} Time & time\_c & 0.00 & 0.00 & 0.19\\
\bottomrule
\addlinespace
\end{tabular}
